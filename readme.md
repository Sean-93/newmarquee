...
**With CDN**: <div>https://cdn.jsdelivr.net/gh/githubUser/example@1.0.0/main.js</div>
<br/>
**Use Locally Without CDN**: Get it from https://cdn.jsdelivr.net/gh/githubUser/example@1.0.0/main.js
